...
#define SCS_MMFSR  (*(volatile unsigned char*) (0xE000ED28u))  // Memory Management Fault Status Register
...
#define SCS_BFAR   (*(volatile unsigned int*)  (0xE000ED38u))  // Bus Fault Manage Address Register
...
void HardFaultHandler(unsigned int* pStack) {
  ...
  HardFaultRegs.mmfsr.byte    = SCS_MMFSR;  // Memory Fault Status Register
